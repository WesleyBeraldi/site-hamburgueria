      ...
      <div className={styles.detalheGrid}>
        ...
        <aside>
          <section className={styles.card}>
            ...
            <div className={styles.aviso}>Catálogo, pedidos, promoções, funcionários, mesas, comandas, pagamentos e estas configurações são salvos no MySQL e compartilhados entre cliente, administrador e garçom.</div>
          </section>
        </aside>
      </div>
    </AdminLayout>
